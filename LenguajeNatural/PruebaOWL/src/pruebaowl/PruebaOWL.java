...
import org.semanticweb.owlapi.apibinding.OWLManager; //ERROR
...
public class PruebaOWL 
{
    private final OWLOntology ontology;
    private OWLDataFactory df;

    public PruebaOWL(OWLOntology ontology, OWLDataFactory df)
    {
    ...
    {
        String x = "./Ontologias/dbpedia_2014.owl"; 
        ...
        PruebaOWL parser = new PruebaOWL(ontology, manager.getOWLDataFactory());
